                ...
                <ul class="flex justify-center gap-2 mt-2">
                    <li>
                        <a href="https://www.linkedin.com/in/trafford-fewster" target="_blank" title="LinkedIn">
                            <svg viewBox="0 0 128 128" class="w-6 h-6 fill-gray-950">
                    ...
                    <li>
                        <a href="https://github.com/TraffordFewster" title="Github">
                            <svg viewBox="0 0 128 128" class="w-6 h-6 fill-gray-950">
                    ...
                    <li>
                        <a href="/resume.pdf" title="Resume">
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="w-6 h-6 fill-gray-950">
